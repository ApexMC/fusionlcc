    ...
    <footer className="border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black">
      <div className="mx-auto px-24 py-8 grid gap-12 md:gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          <iframe 
            title="Map showing Limitless Cheer and Gymnastics"
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <Link href="/contact" className="mt-4 px-4 py-2 font-bold bg-linear-to-r from-purple-700 to-purple-500 text-white rounded hover:from-purple-500 hover:to-purple-700 transition hover:border hover:border-purple-600">
              Contact Us
            </Link>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <ul className="mt-4 space-y-2 text-sm text-zinc-700 dark:text-zinc-200 text-center md:text-start">
            <li><Link href="/classes" className="hover:text-purple-600 transition">Classes</Link></li>
            <li><Link href="/staff" className="hover:text-purple-600 transition">Staff</Link></li>
            <li><Link href="/faq" className="hover:text-purple-600 transition">FAQ</Link></li>
            <li><Link href="/competitive-cheer" className="hover:text-purple-600 transition">Competitive Cheer</Link></li>
